...
def repitch(wav, pitch, tempo, voice=False, quick=False, samplerate=44100):
    ...
    """
    # On Windows, NamedTemporaryFile holds an exclusive lock on the file while
    # open, preventing soundfile and soundstretch from accessing it by name.
    # Use delete=False and close before use, then clean up manually.
